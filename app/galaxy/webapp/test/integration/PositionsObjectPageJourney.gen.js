...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PositionsObjectPageObjectPage journey");

        opaTest("Navigate to PositionsObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheSpacefarersObjectPageGenerated.onTable({ property: "Position" }).iCheckRows();
            When.onTheSpacefarersObjectPageGenerated.onTable({ property: "Position" }).iPressRow(0);

            Then.onThePositionsObjectPageGenerated.iSeeThisPage();
        });
